...
### Контент-пул
17. ✅ Исходные видео (движение + аудио): **предоставляет оператор**
    - ❓ Оператор — это Сергей сам снимает или отдельный человек?
    - ❓ Формат и разрешение: 9:16, 1080×1920?
    - ❓ Как оператор передаёт видео — Google Drive, Telegram, другое?
18. ✅ Одежда: **зависит от задания** (не привязана к конкретной модели)
    - ❓ Кто ставит задание — Сергей вручную или автоматически из каталога?
    - ❓ Задание = (модель + одежда + исходное видео) — в каком формате передаётся?
19. Фон — нейтральный студийный или тематический?
