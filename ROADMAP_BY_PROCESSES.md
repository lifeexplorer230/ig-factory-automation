...
│  └─ Очередь (JSON файлы) ✅        └─ Session файлы ✅         │
│                                                                 │
│  Результат: 10+ видео в очереди     Результат: 5+ аккаунтов   │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
                              ↓
                    ПОТОК 3: ПУБЛИКАЦИЯ
                    ...
                    ├─ Публикуем на аккаунты ⏳ (ждём данные)
                    ├─ Собираем метрики ❌
                    └─ Масштабируем ❌
```
...
14. Сколько аккаунтов запускать параллельно (один прокси!)?

### Публикация
15. Сколько дней прогревать аккаунт перед первой публикацией?
16. Сколько постов в день на один аккаунт в начале?
17. Сначала фото или сразу Reels?
